...
<div class="mdui-container-fluid">
	<div id="footerbar" class="mdui-row" style="position:relative">
		...
		<div class="mdui-col-xs-12 mdui-col-sm-6 mdui-p-y-2 mdui-p-x-4 mdui-color-theme mdui-text-center">
			...
			<a class="mdui-btn mdui-ripple mdui-btn-dense" href="http://www.emlog.net" title="采用emlog系统" rel="nofollow">emlog</a>
			<a class="mdui-btn mdui-ripple mdui-btn-dense" href="http://www.yoniu.xyz" title="本站主题" rel="nofollow">Ting</a>
			<!-- 以上链接已加nofollow，不会影响seo，版权 -->
			<?php if($icp): ?>
...
<script src="<?php echo TEMPLATE_URL; ?>js/player.js?v1.01" type="text/javascript"></script>
